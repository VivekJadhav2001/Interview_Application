    ...
    <div className='card-border w-[360px] max-sm:w-full min-h-96'>
        <div className="card-interview">
            <div className="">
                ...
                <Image src={getRandomInterviewCover()} alt='cover image' width={90} height={90} className='rounded-full object-fit six-[90px]'/>
                ...
                <p className='line-clamp-2 mt-5'>
                            {feedback?.finalAssessment || 'No feedback yet' || "You haven't taken this interview yet. Take it now to imporve your skills"}
                </p>
            </div>
